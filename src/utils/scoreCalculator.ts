...
const CHARACTER_WEIGHTS: Record<string, Record<string, number>> = {
  // カルロッタ（凝縮ダメージ主体）
'カルロッタ': {
    '凝縮ダメージアップ': 1.0,        // メイン：30.0% × 1.0 = 30
    'クリティカル': 2.0,              // サブ：9.9% × 2.0 = 19.8
    'クリティカルダメージ': 2.0,      // サブ：15.0% × 2.0 = 30.0
    '攻撃力': 1.5,                    // サブ：9.4% × 1.5 = 14.1
    '共鳴スキルダメージアップ': 1.0,  // サブ：7.1% × 1.0 = 7.1
    '共鳴解放ダメージアップ': 0.0,    // 評価外：8.6% × 0.0 = 0
    '共鳴効率': 0.4,                  // 前回設定を維持（画像内にデータなし）
    '通常攻撃ダメージアップ': 0.0,    // 評価外
},
};
